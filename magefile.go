...
func Install() error {
	...
	if err := sh.RunV("go", "install", "google.golang.org/grpc/cmd/protoc-gen-go-grpc@latest"); err != nil {
		return err
	}

	fmt.Println("Installing protoc-gen-go")
	if err := sh.RunV("go", "install", "github.com/golang/protobuf/protoc-gen-go@latest"); err != nil {
		return err
	}
	...
	fmt.Println("Installing ent")
	if err := sh.RunV("go", "install", "entgo.io/ent/cmd/ent@latest"); err != nil {
		return err
	}
	...
	if err := sh.RunV("go", "install", "github.com/bufbuild/buf/cmd/buf@latest"); err != nil {
		return err
	}
	return nil
}
